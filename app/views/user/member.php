...
<h1 class="text-center mt-3 text-dark english">member panel(Create access)</h1>

<div class="container-fluid">
    <div class="container">

    <a href="<?php echo URLROOT . "user/create";?>" class="btn btn-primary mb-3">Create New Post</a>
        <div class="row">
            <div class="col-md-4">
                <ul class="list-group">
