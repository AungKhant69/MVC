        ...
        <div class="col-md-8 offset-md-2">
            <div class="card bg-light p-5">
                ...
                <form action="<?php echo URLROOT . 'user/login'?>" method="post" >
                    <h1 class="text-center text-dark mb-3">Login To Post</h1>
                    <div class="mb-3">
                    ...
                    <div class="">
                       <a href="<?php echo  URLROOT . "user/register"?>">Don't have an account? Please register</a>
                           <div class="float-end">
